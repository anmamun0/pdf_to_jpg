...
# The next line defines a function called "pdf_to_jpg" which takes in three parameters: pdf_path: the path to the PDF file that needs to be converted
